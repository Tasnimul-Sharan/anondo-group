        ...
        <div className="space-y-10">
          {companies.map((company) => (
            <div
              ...
              className="cursor-pointer group flex flex-col md:flex-row items-start md:items-center gap-8 bg-white border border-gray-200 rounded-xl p-8 transition hover:border-primary/40 hover:shadow-md"
            >
              {/* Logo */}
              <div className="relative w-60 h-36 flex-shrink-0 flex items-center">
                <Image
              ...
              {/* Button */}
              <div className="md:self-start">
                <span className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary/10 text-primary rounded-full text-sm font-semibold transition-all duration-300 group-hover:bg-primary group-hover:text-white">
                  View Website
